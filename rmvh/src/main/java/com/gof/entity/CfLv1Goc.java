...
public class CfLv1Goc implements java.io.Serializable{
	...
	@Id
	@SequenceGenerator(name = "CF_LV1_SEQ", sequenceName = "CF_LV1_SEQ", initialValue = 1, allocationSize = 50)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CF_LV1_SEQ")
	private Long seqId;
