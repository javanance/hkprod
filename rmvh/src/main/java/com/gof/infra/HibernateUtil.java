...
//    	    File configFile  = new File("com/hkl/ifrs/bat/rmv/hibernate.cfg.rmv.xml");
//    	    File configFile  = new File(HibernateUtil.class.getResource("../hibernate.cfg.rmv.xml").getPath());
    	    //File configFile  = new File(ClassLoader.getSystemResource("com/hkl/ifrs/bat/rmv/hibernate.cfg.rmv.xml").getPath());
	    	URL configFile = HibernateUtil.class.getResource("/com/hkl/ifrs/bat/rmv/hibernate.cfg.rmv.xml");
	    	if(configFile == null) {
	    		configFile = HibernateUtil.class.getClassLoader().getResource("../hibernate.cfg.rmv.xml");
	    	}
