...
/**
 *  <p> BottomUp 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙{@link BottomupDcnt} 占쏙옙 DataBase 占쏙옙占쏙옙 占쏙옙占쏙옙占싹댐옙 占쏙옙占쏙옙占� 占쏙옙占쏙옙占싹댐옙 Class 占쏙옙         
...
public class DfDao {
	...
	public static List<DfLv2WghtHis> getDfLv2WghtHis( ){
		String query = "select a from DfLv2WghtHis a "
				;
	...
	public static List<DfLv2Eir> getLv2Eir(String bssd ){
		String query = "select a from DfLv2Eir a "
				+ "where a.baseYymm  = :bssd "
				;
