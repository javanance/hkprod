...
import com.gof.entity.MstCfLv2;
...
public class MstDao {
	...
	public static List<MstCalcRfwdDetail> getMstCalcRfwdDetail(){
		String query = "select a from MstCalcRfwdDetail a" ;
		return session.createQuery(query, MstCalcRfwdDetail.class).getResultList();
	}
	
	public static List<MstCalcUlRefDetail> getMstCalcUlRefDetail(){
		String query = "select a from MstCalcUlRefDetail a" ;
		return session.createQuery(query, MstCalcUlRefDetail.class).getResultList();
	}
