...
//	TODO :deprecated !!!!
	...
	public static Stream<CfLv3Real> getCfLv3RealGroupByStream(String bssd){
		String query = "select new com.gof.entity.CfLv3Real(a.baseYymm, a.gocId,  a.runsetId, a.liabType,  a.stStatus, a.endStatus, a.newContYn, a.cfType, sum(a.cfAmt)) "
				+ " from CfLv3Real a "
				+ " where a.baseYymm  = :bssd "
				+ " group by a.baseYymm, a.gocId,  a.runsetId, a.liabType, a.stStatus, a.endStatus, a.newContYn, a.cfType"
		;
