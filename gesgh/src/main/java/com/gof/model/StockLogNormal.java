...
public class StockLogNormal {
	...
	public StockLogNormal() {
	}
	
	public StockLogNormal(String bssd, String irCurveId, String sceNo, Map<String, ? extends IIntRate> curveHisMap,  Map<String, Double> lpMap, double ufr, double ufrt) {
		this();
...
//				String script = "SW.run(int, mat, ufr, ufr.t, proj.y = proj.y, int.type = compound)";
				String script = "St.simulation.run.rd.full(s0, int.disc, mat, atm.put.volt, ufr, ufr.t , proj.y=100, int.type =NA, rd, bse.dt = NA, scen.id = NA)";
