...
/**
 *  Controller Class for General Monte Carlo
...
public class MonteCarlo implements Rrunnable {
     ...
     * 
	 * @return List			   :시장변수 시나리오 
	 */
	public List<MvSce> getScenario(String bssd, String mvId, String modelId, int sceNum, int batchNo){
