...
//		logger.info("vasicek : {},{}" , shortRate, getModelResult(sceNum));
		...
		for(int k =0; k< vasicekRst.getElementAsSEXP(0).length(); k++) {
			...
			tempSce.setRfRate(vasicekRst.getElementAsSEXP(6).getElementAsSEXP(k).asReal());
	...
	public List<BizIrCurveSce> getVasicekScenario1(String bssd, String irCurveId, String bizDv, int sceNum, int batchNo){
...
//		logger.info("vasicek : {},{}" , shortRate, getModelResult(sceNum));
		...
		for(int k =0; k< vasicekRst.getElementAsSEXP(0).length(); k++) {
			...
			tempSce.setMatCd("M"+ String.format("%04d", vasicekRst.getElementAsSEXP(4).getElementAsSEXP(k).asInt()));
			tempSce.setRfRate(vasicekRst.getElementAsSEXP(6).getElementAsSEXP(k).asReal());
			tempSce.setRfRate(vasicekRst.getElementAsSEXP(9).getElementAsSEXP(k).asReal());
	...
	public List<BizDiscountRateSce> getBizDiscountSce(String bssd, String irCurveId, String bizDv, int sceNum, int batchNo){
...
//		logger.info("vasicek : {},{}" , shortRate, getModelResult(sceNum));
		...
		for(int k =0; k< vasicekRst.getElementAsSEXP(0).length(); k++) {
			...
			tempSce.setSceNo( String.valueOf(sceNo));
			tempSce.setMatCd("M"+ String.format("%04d", vasicekRst.getElementAsSEXP(4).getElementAsSEXP(k).asInt()));
			tempSce.setRiskAdjRfRate(vasicekRst.getElementAsSEXP(6).getElementAsSEXP(k).asReal());
			tempSce.setRiskAdjRfFwdRate(vasicekRst.getElementAsSEXP(9).getElementAsSEXP(k).asReal());
