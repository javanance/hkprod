...
//	}
	...
	public static List<RstBoxGoc> getRstBoxGroupBy(String bssd ){
		String query = "select new com.hkl.ifrs.bat.entity.RstBoxGoc(a.baseYymm, a.gocId, a.liabType, a.mstRunset, a.calcId, a.stStatus, a.endStatus, a.newContYn"
...
//		String query = "select new com.hkl.ifrs.bat.entity.RstBoxGoc(a.baseYymm, a.gocId, a.liabType, a.mstRunset, a.calcId, sum(a.boxValue)) "
//				+ "from RstBoxGoc a "
//				+ "where a.baseYymm  = :bssd "
//				+ "group by a.baseYymm, a.gocId, a.liabType, a.mstRunset, a.calcId"
//				;
		
		String query = "select new com.hkl.ifrs.bat.entity.RstBoxGoc(a.baseYymm, a.gocId, a.mstRunset, a.calcId, sum(a.boxValue)) "
				+ "from RstBoxGoc a "
				+ "where a.baseYymm  = :bssd "
