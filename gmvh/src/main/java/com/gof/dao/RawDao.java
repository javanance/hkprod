...
public class RawDao {
	...
	public static List<RawModifiedRetroRst> getRawModifiedRetroRst(String bssd ){
		String query = "select a from RawModifiedRetroRst a "
				+ "where a.baseYymm  = :bssd "
				;
		
		Query<RawModifiedRetroRst> q = session.createQuery(query, RawModifiedRetroRst.class);
		q.setParameter("bssd", bssd);
		return q.getResultList();
	}
	
	public static List<RawModifiedRetroRst> getRawModifiedRetroRst(){
		String query = "from RawModifiedRetroRst ";
...
//		String query = "select new com.gof.entity.NcontRstRa(a.baseYymm, a.ctrPolno, sum(raAmt)) "
//				+ " from RawRa a "
//				+ " where a.baseYymm  = :bssd "
...
//		String query = "select new com.gof.entity.NcontRstTvog(a.baseYymm, a.ctrPolno, sum(tvogAmt)) "
//				+ " from RawTvog a "
//				+ "where a.baseYymm  = :bssd "
...
//	}
	...
	public static Stream<RawCf> getRawCfStream(String driveYm){
		String query = "select a from RawCf a "
				+ "where a.driveYm= :driveYm "
		;
		Query<RawCf> q = session.createQuery(query, RawCf.class);
	...
	public static Stream<RawCfLic> getRawCfLicByRsDivStream(String driveYm, String setlYm, String rsDivId){
		String query = "select a from RawCfLic a "
				+ "where a.driveYm= :driveYm "
				+ "and a.setlYm  = :setlYm "
				+ "and a.rsDivId  = :rsDivId "
		;
		Query<RawCfLic> q = session.createQuery(query, RawCfLic.class);
		q.setParameter("driveYm", driveYm);
		q.setParameter("setlYm", setlYm);
		q.setParameter("rsDivId", rsDivId);
	...
	public static Stream<RawCfLic> getRawCfLicByRsDivStream(String driveYm, String setlYm, String rsDivId, String gocId){
		if(gocId==null) {
			return getRawCfLicByRsDivStream(driveYm, setlYm, rsDivId);
		}
		String query = "select a from RawCfLic a "
				+ "where a.driveYm =:driveYm "
				+ "and a.setlYm  = :setlYm "
...
//	}
	...
	public static Stream<RawCash> getRawCashGroupByStream(String bssd){
		String query = "select new com.gof.entity.RawCash(a.baseYymm, a.gocId, a.rsDivId, a.liabType, a.stStatus, a.endStatus, a.newContYn"
				+ ", a.cfKeyId, a.cfType, a.outflowYn, sum(a.cfAmt))  "
				+ " from RawCash a "
				+ " where a.baseYymm  = :bssd "
				+ " group by a.baseYymm, a.gocId, a.rsDivId, a.liabType, a.stStatus, a.endStatus, a.newContYn, a.cfKeyId, a.cfType, a.outflowYn"
		;
	...
	public static Stream<RawCash> getRawCashGroupByStream(String bssd, String gocId){
		if(gocId==null) {
			return getRawCashGroupByStream(bssd);
		}
		String query = "select new com.gof.entity.RawCash(a.baseYymm, a.gocId, a.rsDivId, a.liabType, a.stStatus, a.endStatus, a.newContYn"
				+ ", a.cfKeyId, a.cfType, a.outflowYn, sum(a.cfAmt))  "
				+ " from RawCash a "
