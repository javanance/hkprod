...
//	}
	...
	public static RstRollFwd buildFromDac(String bssd, String gocId, RstDac rstDac) {
		String remark ="FROM RST_DAC";
		double boxAmt = rstDac.getBoxAmt();
		double deltaAmt = rstDac.getDeltaDacAmt();
		double closeAmt = rstDac.getDacAmt();
		
		return build(bssd, gocId, rstDac.getCoaId(),rstDac.getRollFwdType(),rstDac.getRunsetId(), rstDac.getMstCalc(), 1,  boxAmt, deltaAmt, closeAmt,  remark);
	}
	
	public static RstRollFwd buildClose(String bssd,  String gocId,  ECoa coa, ERollFwdType rollFwd, MstCalc mstCalc, double boxAmt,  double deltaAmt, double closeAmt, String remark) {

		return build(bssd, gocId, coa, rollFwd, "CLOSE", mstCalc, 1,  boxAmt, deltaAmt, closeAmt,  remark);
	}
	
	public static RstRollFwd build(String bssd,  String gocId, ECoa coa, ERollFwdType rollFwd, String runsetId,  MstCalc mstCalc, int seq, double boxAmt,  double deltaAmt, double closeAmt, String remark) {
